...
test('glow reduction visual check - gameplay', async ({ page }) => {
  ...
  await page.screenshot({ path: 'tests/screenshots/glow-idle.png' });
  ...
  await page.screenshot({ path: 'tests/screenshots/glow-gameplay.png' });
  ...
  await page.screenshot({ path: 'tests/screenshots/glow-movement.png' });
});
